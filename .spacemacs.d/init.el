...
(custom-set-variables
 ...
 '(package-selected-packages
   '(multiple-cursors yasnippet-snippets which-key use-package unfill treemacs-projectile treemacs-icons-dired quickrun pcre2el overseer nameless mwim macrostep inspector hybrid-mode holy-mode help-fns+ helm-xref helm-themes helm-swoop helm-projectile helm-org helm-mode-manager helm-make helm-flx helm-descbinds helm-company helm-c-yasnippet helm-ag fuzzy flycheck-package flycheck-elsa evil-mc evil-evilified-state emr elisp-slime-nav elisp-def dotenv-mode diminish bind-map auto-yasnippet auto-compile ace-jump-helm-line ac-ispell)))
(custom-set-faces
